...
public class Rotate180Filter implements ImageFilter {
    @Override
    public BufferedImage aplicar(BufferedImage imagen) {
        ...
        try {
            ValidationUtils.validateImage(imagen, "rotate180_input");
        } catch (IOException e) {
        ...
        g.setTransform(AffineTransform.getRotateInstance(Math.toRadians(180), ancho / 2.0, alto / 2.0));
